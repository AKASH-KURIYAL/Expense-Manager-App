...
import Analytics from "../component/Layout/Analytics";
...
const HomePage = () => {
  ...
  //Set the transaction to the table
  const handleSubmit=async(values)=>{
    try{
      ...
      setLoading('false');
      message.error("Transaction didn't added");
    }
  }
  return (
    ...
    <Layout>
      ...
      <div className='filters'>
        <div>
          ...
          <Select value={frequency} onChange = {(values)=> setFrequency(values)} style ={{width:'150px'}}>
